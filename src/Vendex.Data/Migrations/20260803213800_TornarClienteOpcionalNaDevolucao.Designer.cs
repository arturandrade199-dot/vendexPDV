...
namespace Vendex.Data.Migrations
{
    ...
    [Migration("20260803213800_TornarClienteOpcionalNaDevolucao")]
    partial class TornarClienteOpcionalNaDevolucao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vendex.Domain.Entities.ConfiguracaoBackup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("CaminhoDestino")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTime?>("UltimoBackupData")
                        .HasColumnType("TEXT");

                    b.Property<bool>("UltimoBackupSucesso")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Vendex.Domain.Entities.ConfiguracaoImpressao", b =>
                {
                    ...
                    b.Property<bool>("UsarLayoutTermico")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Vendex.Domain.Entities.DevolucaoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Vendex.Domain.Entities.Licenca", b =>
                {
                    ...
                    b.Property<DateTime?>("DataValidaAte")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTime>("UltimaDataVista")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("UltimaVerificacaoOnline")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Vendex.Domain.Entities.DevolucaoItem", b =>
                {
                    b.HasOne("Vendex.Domain.Entities.Devolucao", "Devolucao")
                        .WithMany("Itens")
